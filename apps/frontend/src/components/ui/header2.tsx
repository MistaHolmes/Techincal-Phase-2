...
const Header2 = () => {
  ...
  return (
    <header className="sticky top-0 z-10 border-b border-gray-200/50 dark:border-gray-700/50 bg-white/70 dark:bg-gray-900/70 backdrop-blur-md p-4 md:px-6 flex items-center justify-between transition-all duration-300">
      {/* Left: Logo */}
